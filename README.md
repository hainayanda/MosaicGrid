...
- Choose **Up to Next Major** for the version rule and set the version to **3.0.0**.
...
```swift
dependencies: [
    .package(url: "https://github.com/hainayanda/MosaicGrid.git", .upToNextMajor(from: "3.0.0"))
]
```
