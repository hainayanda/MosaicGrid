...
public extension HMosaicGrid {
    ...
    ///   - content: View that will be used as this Mosaic Grid Content
    @available(iOS 16.0, macOS 13.0, tvOS 16.0, watchOS 9.0, *)
    @inlinable init(vGridCount: Int, spacing: CGFloat, gridAspectRatio: Double = 1, useCompatLayout: Bool, @ViewBuilder content: @escaping () -> Content) {
        self.init(
            vGridCount: vGridCount,
            spacing: MosaicGridSpacing(spacings: spacing),
            gridAspectRatio: gridAspectRatio,
    ...
    ///   - content: View that will be used as this Mosaic Grid Content
    @available(iOS 16.0, macOS 13.0, tvOS 16.0, watchOS 9.0, *)
    @inlinable init(vGridCount: Int, hSpacing: CGFloat = .zero, vSpacing: CGFloat = .zero, gridAspectRatio: Double = 1, useCompatLayout: Bool, @ViewBuilder content: @escaping () -> Content) {
        self.init(
            vGridCount: vGridCount,
            spacing: MosaicGridSpacing(h: hSpacing, v: vSpacing),
            gridAspectRatio: gridAspectRatio,
    ...
    ///   - content: View that will be used as this Mosaic Grid Content
    @available(iOS 16.0, macOS 13.0, tvOS 16.0, watchOS 9.0, *)
    @inlinable init(vGridCount: Int, spacing: CGFloat, gridWidth: CGFloat, useCompatLayout: Bool, @ViewBuilder content: @escaping () -> Content) {
        self.init(
            vGridCount: vGridCount,
            spacing: MosaicGridSpacing(spacings: spacing),
            gridWidth: gridWidth,
    ...
    ///   - content: View that will be used as this Mosaic Grid Content
    @available(iOS 16.0, macOS 13.0, tvOS 16.0, watchOS 9.0, *)
    @inlinable init(vGridCount: Int, hSpacing: CGFloat = .zero, vSpacing: CGFloat = .zero, gridWidth: CGFloat, useCompatLayout: Bool, @ViewBuilder content: @escaping () -> Content) {
        self.init(
            vGridCount: vGridCount,
            spacing: MosaicGridSpacing(h: hSpacing, v: vSpacing),
            gridWidth: gridWidth,
